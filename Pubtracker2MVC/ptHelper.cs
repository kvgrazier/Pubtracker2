...
namespace Pubtracker2MVC
{
    public static class ptHelper
    {
        private static string svcUrl = Pubtracker2MVC.Properties.Settings.Default.RestServiceUrlLocal;
       // private static string svcUrl = PubtrackerMVC.Properties.Settings.Default.RestServiceUrlRemote;
        public static IEnumerable<T> GetAll<T>(string area)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var responseTask = client.GetAsync(area);
                responseTask.Wait();
