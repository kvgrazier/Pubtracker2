...
namespace Pubtracker2MVC.Controllers
{
    public class PublicationsController : Controller
    {
        ...
        { return View(Pubtracker2MVC.ptHelper.GetAll<ptPublication>("publications")); }

        // GET: Publications/Details/5
        public ActionResult Details(string id)
        { return View(Pubtracker2MVC.ptHelper.GetOne<ptPublication>("publications", id)); }
        ...
        {
            if (Pubtracker2MVC.ptHelper.Create<ptPublication>("publications", publication))
        ...
        {
            if (Pubtracker2MVC.ptHelper.Edit<ptPublication>(id, "publications", publication))
            { return RedirectToAction("Index"); }
            else
            { return View(publication); }
        }
        ...
        {
            if (Pubtracker2MVC.ptHelper.DeleteOne<ptPublication>("publications", id))
            { return RedirectToAction("Index"); }
            else
            { return View(); }
        }
